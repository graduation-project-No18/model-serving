...
# maxfreq = np.mean(maxfreq[maxfreq > 0])
#
# input_features = np.array([mfcc_mean[0],mfcc_mean[1], mfcc_mean[2],mfcc_mean[3],mfcc_mean[4],mfcc_mean[5],mfcc_mean[6],
#                            mfcc_mean[7],mfcc_mean[8],mfcc_mean[9],mfcc_mean[10],mfcc_mean[11],mfcc_mean[12],mfcc_mean[13],
#                            mfcc_mean[14],mfcc_mean[15],mfcc_mean[16],mfcc_mean[17],mfcc_mean[18],mfcc_mean[19],spectral_centroids,
#                            spectral_bandwidth,spectral_contrast, spectral_rolloff, meanfreq,
#                            maxfreq])
#
# prediction=rfm.predict(input_features.reshape(1,-1))
...
#     print("톤==여성적")
#     #주파수 데이터
#     data = pd.read_csv('../../Downloads/doremi_fre_girl.csv')
#
#     X = data.iloc[:, 0].values.reshape(42, 1)
#     y = data.iloc[:, 1]
#
...
#     print("톤==남성적")
#     #주파수 데이터
#     data = pd.read_csv('../../Downloads/doremi_fre_boy.csv')
#
#     X = data.iloc[:, 0].values.reshape(42, 1)
#     y = data.iloc[:, 1]
#
...
#
#
# data = pd.read_csv("../../Downloads/Song.csv", encoding="euc-kr")
# X = data.iloc[:, :-1]
# y = data.iloc[:, -1]
#
# X_train, y_train = X, y
...
# row_number3 = list(map(int, row_number3))
#
# print_column_info('../../Downloads/Song_details.xlsx', row_number1[0] + 1)
# print_column_info('../../Downloads/Song_details.xlsx', row_number2[0] + 1)
# print_column_info('../../Downloads/Song_details.xlsx', row_number3[0] + 1)
#
# res = list()
#
#
# def get_result():
#     res.add(print_column_info('../../Downloads/Song_details.xlsx', row_number1[0] + 1))
#     res.add(print_column_info('../../Downloads/Song_details.xlsx', row_number2[0] + 1))
#     res.add(print_column_info('../../Downloads/Song_details.xlsx', row_number3[0] + 1))
#
#     return res
